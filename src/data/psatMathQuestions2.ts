...
export const psatMathQuestionsPart2: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 'A',
    rationale: "Choice A is correct. For $n \\ge 25$, the first 25 people cost $21 \\times 25 = \\$525$. The remaining $(n - 25)$ people cost $14 \\times (n - 25)$. Total $f(n) = 525 + 14n - 350 = 14n + 175$.",
    hints: [
