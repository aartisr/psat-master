...
export const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-12">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="px-2.5 py-0.5 rounded-md text-[10px] font-extrabold uppercase tracking-wider bg-blue-50 text-blue-800 border border-blue-200/80">
              Learning Path Analytics
            </span>
            <span className="text-xs text-slate-600 font-bold">PSAT / SAT Master</span>
          </div>
        ...
        <div className="flex items-center gap-6 sm:gap-8 shrink-0 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-200/80">
          <div className="text-center">
            <p className="text-[10px] uppercase font-bold text-slate-700 tracking-widest">Current Scaled</p>
            <p className="text-2xl sm:text-3xl font-black text-blue-700 font-mono">{estScaledScore * 2}</p>
          </div>
          <div className="h-8 w-px bg-slate-200" />
          <div className="text-center">
            <p className="text-[10px] uppercase font-bold text-slate-700 tracking-widest">Accuracy</p>
          ...
          <div className="h-8 w-px bg-slate-200" />
          <div className="text-center">
            <p className="text-[10px] uppercase font-bold text-slate-700 tracking-widest">Day Streak</p>
            <p className="text-2xl sm:text-3xl font-black text-amber-700 font-mono flex items-center justify-center gap-1">
      ...
      <div className="bg-[#0F172A] rounded-3xl p-6 sm:p-8 text-white shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border border-slate-800 relative overflow-hidden">
        ...
        <div className="space-y-1.5 relative z-10">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="text-xs text-amber-300 font-semibold bg-amber-950/60 px-2.5 py-1 rounded-full border border-amber-800/60">
              National Merit Selection Index (NMSC SI) Projected: {Math.round(200 + (analytics.overallAccuracy / 100) * 28)}
            </span>
          </div>
          <h2 className="text-xl sm:text-3xl font-extrabold tracking-tight text-white">Adaptive Skill Diagnostics</h2>
        ...
        <div className="flex flex-wrap items-center gap-3 relative z-10">
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs sm:text-sm rounded-2xl transition-all shadow-lg active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white font-extrabold text-xs sm:text-sm rounded-2xl transition-all active:scale-95 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-700">Overall Accuracy</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-700">Est. Math Scaled</span>
            <Award className="w-4 h-4 text-indigo-600" />
          </div>
          <div className="text-2xl sm:text-3xl font-black text-indigo-700">
            {estScaledScore} <span className="text-sm font-semibold text-slate-600">/ 720</span>
          </div>
          <div className="text-xs text-slate-600 font-medium mt-1">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-700">Total Attempts</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-700">Time Invested</span>
            <Clock className="w-4 h-4 text-amber-600" />
          </div>
          <div className="text-2xl sm:text-3xl font-black text-slate-900">
            {Math.round(analytics.timeSpentTotalSeconds / 60)} <span className="text-sm font-semibold text-slate-600">min</span>
          </div>
          <div className="text-xs text-slate-600 font-medium mt-1">
