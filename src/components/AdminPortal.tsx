...
import { AdminTicketsQueue } from './admin/AdminTicketsQueue';
...
export type AdminTab = 'upload' | 'create' | 'manage' | 'tickets' | 'auditor' | 'logs' | 'telemetry';
...
export const AdminPortal: React.FC<AdminPortalProps> = React.memo(({
  ...
  return (
    <div className="space-y-6">
      ...
      {activeAdminTab === 'tickets' && (
        <AdminTicketsQueue allQuestions={allQuestions} />
      )}
