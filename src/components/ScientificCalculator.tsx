...
export const ScientificCalculator: React.FC<ScientificCalculatorProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed bottom-3 right-3 left-3 sm:left-auto sm:bottom-6 sm:right-6 z-50 w-auto sm:w-96 max-w-[calc(100vw-1.5rem)] max-h-[90vh] overflow-y-auto bg-slate-900 text-white rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-700/90 animate-in slide-in-from-bottom-5">
      {/* Header */}
