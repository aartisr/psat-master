...
export const SupportFeedbackHub: React.FC<SupportFeedbackHubProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {/* Community FAQ & Quick Help Accordion */}
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-2xs space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/70 space-y-1.5">
            <h4 className="font-bold text-slate-900 text-sm">Where do these practice questions come from?</h4>
            <p className="text-slate-600 leading-relaxed">
              All 2,900+ questions are drawn directly from official College Board educator question releases, public SAT Suite banks, and released non-adaptive practice forms.
            </p>
          </div>

          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/70 space-y-1.5">
            <h4 className="font-bold text-slate-900 text-sm">How does the Bluebook multistage adaptive test simulator work?</h4>
            <p className="text-slate-600 leading-relaxed">
              It matches the real digital testing engine: answering ≥ 65% of Module 1 correctly routes you to Module 2 Upper (Hard Stage), unlocking top-tier scaled scores up to 1520/1600.
            </p>
          </div>

          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/70 space-y-1.5">
            <h4 className="font-bold text-slate-900 text-sm">Is an account required to practice?</h4>
            <p className="text-slate-600 leading-relaxed">
              No! You can practice as a Guest with full access to questions, drills, scratchpad, and calculator. Creating a free account enables cloud sync across devices and persistent analytics.
            </p>
          </div>

          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/70 space-y-1.5">
            <h4 className="font-bold text-slate-900 text-sm">What is the National Merit Selection Index (NMSC SI)?</h4>
            <p className="text-slate-600 leading-relaxed">
              The NMSC Selection Index equals 2 × (Reading/Writing Score) + Math Score (range 48–228). State cutoffs for Semifinalists typically range from 207 to 224.
            </p>
          </div>
        </div>
      </div>
