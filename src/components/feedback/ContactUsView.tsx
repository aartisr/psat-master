    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          {/* Dedication & Open Source Mission Card */}
          <div className="bg-gradient-to-br from-indigo-900 via-indigo-950 to-slate-900 text-white rounded-3xl p-6 shadow-md border border-indigo-800/60 relative overflow-hidden space-y-4">
            <div className="relative z-10 space-y-3">
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <span className="text-[10px] font-extrabold uppercase tracking-widest text-indigo-300 bg-indigo-500/20 px-2.5 py-0.5 rounded-full border border-indigo-400/30">
              ...
              <p className="text-xs text-indigo-100/90 leading-relaxed">
                Created as a quiet sanctuary for learning, completely free from forced logins, paywalls, ads, and marketing popups. PSAT Master is an open-source community movement that belongs to the students, faculty, and scholars of Pioneer Charter School of Science II (PCSS II) and learners worldwide.
              </p>

              <div className="p-3 bg-white/5 rounded-2xl border border-white/10 text-[11px] text-indigo-200/90 leading-relaxed italic">
                &ldquo;We invite our community of students, teachers, parents, and developers to join us — audit rationales, contribute questions, refine code, and help make this sanctuary belong to everyone.&rdquo;
              </div>
              ...
              <div className="pt-2 flex flex-wrap gap-3 text-xs font-bold">
                ...
                >
                  PCSS II Portal <ExternalLink className="w-3.5 h-3.5" />
                </a>
                <a
                  href="https://github.com/aartisr/psat-master"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-white hover:text-amber-300 transition-colors underline underline-offset-2"
                >
