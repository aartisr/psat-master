  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-slate-100">
      ...
      <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 flex-wrap">
        {formattedTime && (
          <div className="flex items-center gap-1 px-2 sm:px-2.5 py-1 bg-slate-100 rounded-lg text-xs font-mono text-slate-600 font-semibold mr-0.5">
        ...
        {onToggleSpeech && (
          <button
            ...
            className={`p-2 sm:p-1.5 rounded-lg border transition-colors cursor-pointer min-w-[36px] min-h-[36px] sm:min-w-0 sm:min-h-0 flex items-center justify-center ${
              isSpeaking
        ...
        {onOpenScratchpad && (
          <button
            ...
            className="p-2 sm:p-1.5 rounded-lg border border-slate-200 bg-white text-slate-500 hover:text-indigo-600 hover:bg-slate-50 transition-colors cursor-pointer min-w-[36px] min-h-[36px] sm:min-w-0 sm:min-h-0 flex items-center justify-center"
        ...
        {onReportIssue && (
          <button
            ...
            className="p-2 sm:p-1.5 rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-rose-600 hover:bg-rose-50 hover:border-rose-200 transition-colors cursor-pointer min-w-[36px] min-h-[36px] sm:min-w-0 sm:min-h-0 flex items-center justify-center"
