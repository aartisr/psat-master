...
import { evaluateAnswer, getResolvedCorrectOption } from '../utils/answerEvaluator';

export interface QuestionCardProps {
  question: Question;
  isBookmarked: boolean;
  onToggleBookmark: (id: string) => void;
  onAttemptSubmitted?: (isCorrect: boolean, timeSpent: number, hintsUsed: number, userAnswer?: string) => void;
...
export const QuestionCard: React.FC<QuestionCardProps> = React.memo(({
  ...
  const handleSubmit = useCallback(() => {
    ...
    if (onAttemptSubmitted) {
      onAttemptSubmitted(correct, seconds, revealedHintLevel, submittedAnswer);
    }
  }, [
    isSubmitted,
    question,
